  ...
  if(screen==="result"&&result){
    ...
    return(
      <div style={{...base,overflowY:"auto"}}><Orbs/><Stars/>
        <div style={{position:"relative",zIndex:1,maxWidth:500,margin:"0 auto",padding:"22px 16px 48px",opacity:resultVisible?1:0,transition:"opacity 0.45s"}}>
          ...
          <div style={{textAlign:"center",marginBottom:20,animation:"fadeUp 0.5s ease"}}>
            ...
            <div style={{display:"flex",gap:7,justifyContent:"center",marginBottom:11}}>
              {mainTypes.map(t=>(
                <span key={t} style={{padding:"4px 13px",borderRadius:11,fontSize:11,fontWeight:800,background:`${TYPE_COLORS[t]||"#888"}38`,border:`1px solid ${TYPE_COLORS[t]||"#888"}77`,color:TYPE_COLORS[t]||"#ccc",letterSpacing:1}}>{t.toUpperCase()}</span>
              ))}
            </div>
